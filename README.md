...
|------------------|------------------------------------------------------------------------------------------------------|----------------------------------------------|-------------|
| **Gaurdian-IO**  | Wildlife security & Anti-Slavery System | Next-gen security authentication for decentralized environments.                                      | Vue.js 3, Nuxt.js 3, Node.js, MongoDB        | 🚀 In-Dev   |
